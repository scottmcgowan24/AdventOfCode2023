...
def get_hand_type(hand):
    ...
    for card in hand:
        if card in cards_seen:
            ...
            if new_value > max_seen:
                max_seen = new_value
            elif new_value > second_max_seen:
                second_max_seen = new_value
            else:
                # No op
                continue
    ...
    elif max_seen == 3 and second_max_seen == 2:
        return 5 # Full house
    elif max_seen == 3:
        return 4 # Three of a kind
    elif max_seen == 2 and second_max_seen == 2:
        return 3 # Two pair
    elif max_seen == 2:
        return 2 # One pair
    else:
